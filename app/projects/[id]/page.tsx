...
export default function TaskPage({
  ...
  useEffect(() => {
    ...
    async function checkAccess() {
      try {
        const res = await fetch(`/api/projects/${projectId}/membership`);
  ...
  }, [projectId, filter, sort, userRole]);
  ...
  useEffect(() => {
    if (!loadingMembership && userRole !== null) {
      fetchTasks();
      fetchUsers();
    }
  }, [loadingMembership, userRole, fetchTasks]);
